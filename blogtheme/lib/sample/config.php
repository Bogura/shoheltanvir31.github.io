           ...
           array(
				...
				'options' => array(
					...
					'default' => array(
						...
						'youtube-url' => 'https://www.youtube.com/channel/UCPHhDYDgPeHgp9JsT899eDw',
						'android-url' => '#',
    ...
    Redux::setSection( $opt_name, array(
       ...
       'fields'           => array(
           ...
           array(
                ...
                'default'  => 'Copyright By Blog-Theme',
            ),
...
Redux::setSection( $opt_name, array(
       ...
       'fields'           => array(
           ...
           array(
                'id'       => 'cat-seven',
                'type'     => 'select',
                'title'    => __( 'Sidebar-cetagory-one', 'redux-framework-demo' ),
                'subtitle'  => __( 'Please Select Your Category', 'redux-framework-demo' ),
                'desc'      => __( '1st Create Category From Posts-> Category, Then Select Here.', 'redux-framework-demo' ),
                'default'  => '1',
                'data'  => 'category',
           ...
           array(
                'id'       => 'cat-eight',
                'type'     => 'select',
                'title'    => __( 'Sidebar-cetagory-two', 'redux-framework-demo' ),
                'subtitle'  => __( 'Please Select Your Category', 'redux-framework-demo' ),
                'desc'      => __( '1st Create Category From Posts-> Category, Then Select Here.', 'redux-framework-demo' ),
                'default'  => '1',
                'data'  => 'category',
           ...
           array(
            ...
            array(
                'id'       => 'cat-nine',
                'type'     => 'select',
                'title'    => __( 'Sidebar-cetagory-three', 'redux-framework-demo' ),
                'subtitle'  => __( 'Please Select Your Category', 'redux-framework-demo' ),
                'desc'      => __( '1st Create Category From Posts-> Category, Then Select Here.', 'redux-framework-demo' ),
                'default'  => '1',
                'data'  => 'category',
           ...
           array(
                'id'       => 'cat-ten',
                'type'     => 'select',
                'title'    => __( 'Sidebar-cetagory-four', 'redux-framework-demo' ),
                'subtitle'  => __( 'Please Select Your Category', 'redux-framework-demo' ),
                'desc'      => __( '1st Create Category From Posts-> Category, Then Select Here.', 'redux-framework-demo' ),
                'default'  => '1',
                'data'  => 'category',
